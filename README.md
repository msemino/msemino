...
### AI Systems & Automation Architect · 30+ years in systems engineering

**I design and run AI systems that actually ship — agents, automation, and local-first infrastructure on hardware I own.** Less "I tried an LLM", more "here's the distributed system, the trade-offs, and why it runs unattended for months."
